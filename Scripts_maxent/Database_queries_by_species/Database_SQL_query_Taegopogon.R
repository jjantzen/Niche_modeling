...
Tibouchina_data <- "./../../Database/R_Project/Databases/Tibouchina_database.sqlite"
...
#Write data to file
write.csv(unique_results, "./Data/Occurrence_records_by_species/Taegopogon_unique.csv", row.names = FALSE)
