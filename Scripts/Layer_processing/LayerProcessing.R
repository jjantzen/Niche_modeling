...
#Gets a list of .asc files - check path to correct folder - modified (first need to unzip)
envtList <- list.files(path = "./Layers/WorldClimTerrestrial/", pattern = ".asc", full.names = TRUE)
