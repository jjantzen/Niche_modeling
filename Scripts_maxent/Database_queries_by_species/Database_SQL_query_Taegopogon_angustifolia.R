...
query <- "SELECT DISTINCT specificEpithet, infraspecificEpithet, scientificName, day, month, year, latitude, longitude
...
#Write data to file
write.csv(unique_results, "./Data/Occurrence_records_by_species/Taegopogon_angustifolia_unique.csv", row.names = FALSE)
